...
class ClientHandler implements Runnable {
	...
	private DepartmentService departmervntService;
	private CourseService courseSeice;
	...
	public ClientHandler(Socket clientSocket) {
		...
		this.departmervntService = new DepartmentService(this.entityManager);
		this.courseSeice = new CourseService(this.entityManager);
	}
